...
class CLAPWrapper():
    ...
    def __init__(self, version: str = '2023', use_cuda=False):
    ...
    def get_embeddings(self, audio):
        r"""Load list of audio files and return a audio embeddings"""
        return self.clap.audio_encoder(audio)[1], self.clap.audio_encoder(audio)[2]
    ...
    def compute_similarity(self, audio_embeddings, text_embeddings):
        ...
        similarity = (logit_scale*text_embeddings @ audio_embeddings.T).softmax(dim=-1)
        return similarity.T
