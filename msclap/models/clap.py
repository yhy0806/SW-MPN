...
class AudioEncoder(nn.Module):
    ...
    def forward(self, x):
        ...
        #return projected_vec, audio_features, audio_classification_output
        return audio_features, audio_classification_output

class TextEncoder(nn.Module):
    def __init__(self, d_out: int, text_model: str, text_model_path:str, transformer_embed_dim: int) -> None:
        super().__init__()
        self.text_model = text_model
        self.text_model_path = text_model_path
        self.base = AutoModel.from_pretrained(text_model_path)
...
class CLAP(nn.Module):
    def __init__(self,
        ...
        #    d_proj, text_model, text_model_path, transformer_embed_dim
        #)
    ...
    def forward(self, audio):
        audio_embed, y = self.audio_encoder(audio)
        #caption_embed = self.caption_encoder(text)

        #return caption_embed, audio_embed, self.logit_scale.exp()
        return audio_embed, y